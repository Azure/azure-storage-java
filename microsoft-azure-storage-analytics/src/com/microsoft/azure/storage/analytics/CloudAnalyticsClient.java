...
public class CloudAnalyticsClient {
     ...
     *            A {@link CloudStorageAccount} object containing the credentials and endpoints to use to create the client.
     *
     * @return An analytics client object that uses the Blob and Table service endpoints.
     */
    public static CloudAnalyticsClient createCloudAnalyticsClient(CloudStorageAccount cloudStorageAccount) {
        ...
        return new CloudAnalyticsClient(cloudStorageAccount.getBlobStorageUri(), cloudStorageAccount.getTableStorageUri(), cloudStorageAccount.getCredentials());
    }
