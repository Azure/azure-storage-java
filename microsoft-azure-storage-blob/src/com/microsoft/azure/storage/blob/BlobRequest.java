...
final class BlobRequest {
    ...
    public static String getUserAgent() {
        if (userAgent == null) {
            ...
            userAgent = String.format("%s/%s %s", Constants.HeaderConstants.USER_AGENT_PREFIX,
                    BlobConstants.USER_AGENT_VERSION, userAgentComment);
        }
    ...
    public static final void signRequest(HttpURLConnection request, ServiceClient client,
        ...
        StorageCredentialsHelperForBlob.signRequest(client.getCredentials(), request, contentLength, context);
    }
    ...
    public static HttpURLConnection abortCopy(final URI uri, final BlobRequestOptions blobOptions,
        ...
        final HttpURLConnection request = BlobRequest.createURLConnection(uri, blobOptions, builder, opContext);
    ...
    public static HttpURLConnection createContainer(final URI uri, final BlobRequestOptions blobOptions,
        ...
        final HttpURLConnection request = BlobRequest.create(uri, blobOptions, containerBuilder, opContext);
    ...
    public static HttpURLConnection deleteBlob(final URI uri, final BlobRequestOptions blobOptions,
        ...
        final HttpURLConnection request = delete(uri, blobOptions, builder, opContext);
    ...
    public static HttpURLConnection deleteContainer(final URI uri, final BlobRequestOptions blobOptions,
        ...
        final UriQueryBuilder containerBuilder = getContainerUriQueryBuilder();
        HttpURLConnection request = delete(uri, blobOptions, containerBuilder, opContext);
        if (accessCondition != null) {
            accessCondition.applyConditionToRequest(request);
        }
    ...
    private static HttpURLConnection getProperties(final URI uri, final BlobRequestOptions blobOptions,
        ...
        HttpURLConnection request = getProperties(uri, blobOptions, builder, opContext);
    ...
    public static HttpURLConnection putBlob(final URI uri, final BlobRequestOptions blobOptions,
        ...
        final HttpURLConnection request = BlobRequest.createURLConnection(uri, blobOptions, null, opContext);
    ...
    private static HttpURLConnection setMetadata(final URI uri, final BlobRequestOptions blobOptions,
            ...
            throws IOException, URISyntaxException, StorageException {
        final HttpURLConnection request = setMetadata(uri, blobOptions, builder, opContext);
