 ...
 */
public class SharedAccessSignatureHelperForBlob {
    /**
   ...
   /**
    ...
    static UriQueryBuilder generateSharedAccessSignatureHelper(
        ...
        builder.add(Constants.QueryConstants.SIGNED_VERSION, BlobConstants.TARGET_STORAGE_VERSION);
    ...
    static String generateSharedAccessSignatureStringToSign(
        ...
        String stringToSign = String.format("%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s",
                ...
                BlobConstants.TARGET_STORAGE_VERSION);
     ...
     */
    private SharedAccessSignatureHelperForBlob() {
        // No op
    }
}
