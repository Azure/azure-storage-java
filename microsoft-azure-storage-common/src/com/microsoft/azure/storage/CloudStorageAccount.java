...
public final class CloudStorageAccount {
    ...
    public String generateSharedAccessSignature(SharedAccessAccountPolicy policy)
        ...
        if (!StorageCredentialsHelperForAccount.canCredentialsSignRequest(this.getCredentials())) {
            throw new IllegalArgumentException(SR.CANNOT_CREATE_SAS_WITHOUT_ACCOUNT_KEY);
        }
        
        final String sig = SharedAccessSignatureHelperForAccount.generateSharedAccessSignatureHashForAccount(
                this.credentials.getAccountName(), policy, this.getCredentials());
        final UriQueryBuilder sasBuilder =
                SharedAccessSignatureHelperForAccount.generateSharedAccessSignatureForAccount(policy, sig);
