 ...
 */
public class SharedAccessSignatureHelperForAccount {
    /**
     ...
     * @throws StorageException
     */
    static String generateSharedAccessSignatureHashHelper(String stringToSign, final StorageCredentials creds)
        ...
        return StorageCredentialsHelperForAccount.computeHmac256(creds, stringToSign);
    }
    
    /**
     * Private Default Ctor.
     */
    private SharedAccessSignatureHelperForAccount() {
        // No op
    }
}
