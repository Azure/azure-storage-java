...
public final class CloudTable {
        ...
        try {
            ...
            final StorageRequest<CloudTableClient, CloudTable, Void> putRequest = new StorageRequest<CloudTableClient, CloudTable, Void>(
                ...
                public void signRequest(HttpURLConnection connection, CloudTableClient client, OperationContext context)
                        throws Exception {
                    TableRequest.signRequest(connection, client, aclBytes.length, context);
                }
    ...
    public String generateSharedAccessSignature(
        ...
        if (!StorageCredentialsHelperForAccount.canCredentialsSignRequest(this.tableServiceClient.getCredentials())) {
            throw new IllegalArgumentException(SR.CANNOT_CREATE_SAS_WITHOUT_ACCOUNT_KEY);
        }

        final String resourceName = this.getSharedAccessCanonicalName();

        final String signature = SharedAccessSignatureHelperForTable.generateSharedAccessSignatureHashForTable(
        ...
        final UriQueryBuilder builder = SharedAccessSignatureHelperForTable.generateSharedAccessSignatureForTable(
