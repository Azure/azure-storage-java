...
public final class CloudTableClient extends ServiceClient {
    ...
    protected StorageRequest<ServiceClient, Void, ServiceProperties> downloadServicePropertiesImpl(final RequestOptions options) {
        final StorageRequest<ServiceClient, Void, ServiceProperties> getRequest = new StorageRequest<ServiceClient, Void, ServiceProperties>(
            ...
            public HttpURLConnection buildRequest(ServiceClient client, Void parentObject, OperationContext context)
                    throws Exception {
                return TableRequest.getServiceProperties(
            ...
            public void signRequest(HttpURLConnection connection, ServiceClient client, OperationContext context)
                    throws Exception {
                TableRequest.signRequest(connection, client, -1, context);
            }
    ...
    protected StorageRequest<ServiceClient, Void, ServiceStats> getServiceStatsImpl(final RequestOptions options) {
        final StorageRequest<ServiceClient, Void, ServiceStats> getRequest = new StorageRequest<ServiceClient, Void, ServiceStats>(
            ...
            public HttpURLConnection buildRequest(ServiceClient client, Void parentObject, OperationContext context)
                    throws Exception {
                return TableRequest.getServiceStats(
        ...
        try {
            ...
            final StorageRequest<ServiceClient, Void, Void> putRequest = new StorageRequest<ServiceClient, Void, Void>(
                ...
                public HttpURLConnection buildRequest(ServiceClient client, Void parentObject, OperationContext context)
                    ...
                    return TableRequest.setServiceProperties(
                            credentials.transformUri(client.getEndpoint()), options, null, context);
                }
                ...
                public void signRequest(HttpURLConnection connection, ServiceClient client, OperationContext context)
                        throws Exception {
                    TableRequest.signRequest(connection, client, descriptor.getLength(), context);
                }
     ...
     */
    public static CloudTableClient createCloudTableClient(CloudStorageAccount cloudStorageAccount) {
        if (cloudStorageAccount.getTableStorageUri() == null) {
        ...
        return new CloudTableClient(cloudStorageAccount.getTableStorageUri(), cloudStorageAccount.getCredentials());
    }
    ...
    private <T extends TableEntity, R> StorageRequest<CloudTableClient, TableQuery<T>, ResultSegment<T>> executeQuerySegmentedCoreImpl(
        ...
        final StorageRequest<CloudTableClient, TableQuery<T>, ResultSegment<T>> getRequest = new StorageRequest<CloudTableClient, TableQuery<T>, ResultSegment<T>>(
            ...
            public void signRequest(HttpURLConnection connection, CloudTableClient client, OperationContext context)
                    throws Exception {
                TableRequest.signRequest(connection, client, -1L, context);
            }
