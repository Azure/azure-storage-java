...
public class StorageUriTests {
    ...
    public void testCloudStorageAccountWithStorageUri() throws URISyntaxException, InvalidKeyException {
        ...
        assertEquals(blobEndpoint, CloudBlobClient.createCloudBlobClient(account).getStorageUri());
        assertEquals(queueEndpoint, CloudQueueClient.createCloudQueueClient(account).getStorageUri());
        assertEquals(tableEndpoint, CloudTableClient.createCloudTableClient(account).getStorageUri());
