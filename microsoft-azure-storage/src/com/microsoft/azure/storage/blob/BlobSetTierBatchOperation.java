...
public final class BlobSetTierBatchOperation extends BlobBatchOperation<Void> {
    ...
    public void addSubOperation(CloudBlockBlob blockBlob, StandardBlobTier tier, BlobRequestOptions options) {
        ...
        super.addSubOperation(blockBlob.uploadBlobTierImpl(tier.toString(), options));
    }
    ...
    public void addSubOperation(CloudPageBlob pageBlob, PremiumPageBlobTier tier, BlobRequestOptions options) {
        ...
        super.addSubOperation(pageBlob.uploadBlobTierImpl(tier.toString(), options));
    }
}
