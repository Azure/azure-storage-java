...
/**
 * Anonymous credentials are to be used with with HTTP(S) requests that read public resources or requests
...
public final class AnonymousCredentials implements ICredentials {
     ...
     * {@link ServiceSASSignatureValues} for more information on SAS requests.
     */
