 ...
 */
public final class MessageClearResponse extends RestResponse<MessageClearHeaders, Void> {
    /**
     ...
     */
    public MessageClearResponse(HttpRequest request, int statusCode, MessageClearHeaders headers, Map<String, String> rawHeaders, Void body) {
     ...
     */
    @Override
    public MessageClearHeaders headers() {
