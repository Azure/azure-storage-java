 ...
 */
public final class MessageIDDeleteResponse extends RestResponse<MessageIDDeleteHeaders, Void> {
    /**
     ...
     */
    public MessageIDDeleteResponse(HttpRequest request, int statusCode, MessageIDDeleteHeaders headers, Map<String, String> rawHeaders, Void body) {
     ...
     */
    @Override
    public MessageIDDeleteHeaders headers() {
