 ...
 */
public final class MessageIDUpdateResponse extends RestResponse<MessageIDUpdateHeaders, Void> {
    /**
     ...
     */
    public MessageIDUpdateResponse(HttpRequest request, int statusCode, MessageIDUpdateHeaders headers, Map<String, String> rawHeaders, Void body) {
     ...
     */
    @Override
    public MessageIDUpdateHeaders headers() {
