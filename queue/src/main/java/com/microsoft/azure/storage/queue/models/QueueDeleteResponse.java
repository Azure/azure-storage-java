 ...
 */
public final class QueueDeleteResponse extends RestResponse<QueueDeleteHeaders, Void> {
    /**
     ...
     */
    public QueueDeleteResponse(HttpRequest request, int statusCode, QueueDeleteHeaders headers, Map<String, String> rawHeaders, Void body) {
     ...
     */
    @Override
    public QueueDeleteHeaders headers() {
