...
public final class QueueSetAccessPolicyHeaders {
     ...
     */
    public QueueSetAccessPolicyHeaders withRequestId(String requestId) {
     ...
     * @return the QueueSetAccessPolicyHeaders object itself.
     */
    public QueueSetAccessPolicyHeaders withVersion(String version) {
     ...
     * @return the QueueSetAccessPolicyHeaders object itself.
     */
    public QueueSetAccessPolicyHeaders withDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
