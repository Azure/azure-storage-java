 ...
 */
public final class QueueSetAccessPolicyResponse extends RestResponse<QueueSetAccessPolicyHeaders, Void> {
    /**
     ...
     */
    public QueueSetAccessPolicyResponse(HttpRequest request, int statusCode, QueueSetAccessPolicyHeaders headers, Map<String, String> rawHeaders, Void body) {
     ...
     */
    @Override
    public QueueSetAccessPolicyHeaders headers() {
