 ...
 */
public final class QueueSetMetadataResponse extends RestResponse<QueueSetMetadataHeaders, Void> {
    /**
     ...
     */
    public QueueSetMetadataResponse(HttpRequest request, int statusCode, QueueSetMetadataHeaders headers, Map<String, String> rawHeaders, Void body) {
     ...
     */
    @Override
    public QueueSetMetadataHeaders headers() {
