...
public final class ServiceListQueuesSegmentHeaders {
     ...
     */
    public ServiceListQueuesSegmentHeaders withRequestId(String requestId) {
     ...
     * @return the ServiceListQueuesSegmentHeaders object itself.
     */
    public ServiceListQueuesSegmentHeaders withVersion(String version) {
     ...
     * @return the ServiceListQueuesSegmentHeaders object itself.
     */
    public ServiceListQueuesSegmentHeaders withDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
